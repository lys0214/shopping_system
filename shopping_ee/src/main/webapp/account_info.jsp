		...
		<main class="main-cont content mCustomScrollbar">
			<div class="page-wrap">
				...
				<section class="page-hd">
					...
					<button class="btn btn-primary" onclick="javascript:window.location.href='AccountServlet?flag=toInsert'">新建用户</button>
				</section>
				<table class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${requestScope.list }" var="a">
						<tr class="cen">
							...
							<td>
								<button class="btn-warning" onclick="javascript:window.location.href='AccountServlet?flag=update&accountId=${a.accountId}'">编辑</button>
